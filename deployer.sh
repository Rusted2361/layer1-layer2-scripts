...
rm -rf .op-deployer
./bin/op-deployer apply --workdir .deployer --l1-rpc-url http://127.0.0.1:8545 --private-key 0x2e0834786285daccd064ca17f1654f67b4aef298acbb82cef9ec422fb4975622 --deployment-target=live
